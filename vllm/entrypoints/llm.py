...
# mini-vLLM: Pooling outputs removed (ClassificationRequestOutput, EmbeddingRequestOutput, PoolingRequestOutput, ScoringRequestOutput)
from vllm.platforms import current_platform
# mini-vLLM: PoolingParams and PoolingTask removed
...
class LLM:
    ...
    # mini-vLLM: Pooling methods (encode, embed, classify, reward, score) removed
    # These methods are not supported in mini-vLLM as it focuses on text generation only.

    def encode(self, *args, **kwargs):
        """Not supported in mini-vLLM."""
        raise NotImplementedError("Pooling/encoding is not supported in mini-vLLM")

    def embed(self, *args, **kwargs):
        """Not supported in mini-vLLM."""
        raise NotImplementedError("Embedding is not supported in mini-vLLM")

    def classify(self, *args, **kwargs):
        """Not supported in mini-vLLM."""
        raise NotImplementedError("Classification is not supported in mini-vLLM")

    def reward(self, *args, **kwargs):
        """Not supported in mini-vLLM."""
        raise NotImplementedError("Reward is not supported in mini-vLLM")

    def score(self, *args, **kwargs):
        """Not supported in mini-vLLM."""
        raise NotImplementedError("Scoring is not supported in mini-vLLM")
