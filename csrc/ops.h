...
#ifndef USE_ROCM
// AWQ functions - REMOVED for mini-vllm (not needed for GPT models)

torch::Tensor permute_cols(torch::Tensor const& A, torch::Tensor const& perm);
#endif

// GGML functions - REMOVED for mini-vllm (not needed for GPT models)
...
// GPTQ functions - REMOVED for mini-vllm (not needed for GPT models)
...
// selective_scan_fwd - REMOVED for mini-vllm (Mamba not needed for GPT models)
...
// hadacore_transform - REMOVED for mini-vllm (not needed for GPT models)
