...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
  ...
  // Quantization ops
#ifndef USE_ROCM
  // AWQ ops - REMOVED for mini-vllm (not needed for GPT models)
  // If AWQ support is needed, copy csrc/quantization/awq/ from parent vLLM
  ...
  // GGML kernels - REMOVED for mini-vllm (not needed for GPT models)
  // If GGML/llama.cpp support is needed, copy csrc/quantization/gguf/ from parent vLLM
  ...
  // GPTQ ops - REMOVED for mini-vllm (not needed for GPT models)
  // If GPTQ support is needed, copy csrc/quantization/gptq/ from parent vLLM
  ...
  // Mamba selective scan kernel - REMOVED for mini-vllm (not needed for GPT models)
  // If Mamba support is needed, copy csrc/mamba/ from parent vLLM

  // Hadamard transforms - REMOVED for mini-vllm (not needed for GPT models)
  // If hadacore support is needed, copy csrc/quantization/hadamard/ from parent vLLM
